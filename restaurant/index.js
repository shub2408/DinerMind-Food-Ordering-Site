...
function displayItems(){
    ...
    var excessFood=  document.getElementById('excess-food');
    ...
    const excessData= foodItem.filter((item)=>item.category=='excess-food');
    biryaniData.map(item=>{
        ...
        heart.setAttribute('class','fab fa-gratipay add-to-cart');
    ...
    excessData.map(item=>{
       ...
       /* itemCard.appendChild(itemPrice);*/
        ...
        excessFood.appendChild(itemCard)
